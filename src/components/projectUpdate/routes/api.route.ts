...
class ProjectUpdateRoutes {
    ...
    constructor () 
    {
        ...
        this._route.get("/:projectId", RoleMiddleware(["admin", "projectManager", "client"]), new ProjectUpdateController().projectUpdates)
        this._route.get("/:id/detail", RoleMiddleware(["admin", "projectManager", "client"]), new ProjectUpdateController().detail)
